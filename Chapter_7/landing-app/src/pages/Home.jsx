  ...
  return isLoggedIn ? (
    <div className="background">
      <Container>
        ...
        <Alert variant="dark" className="w-25 text-center ms-auto">{user.name}!</Alert>
                ...
                <Col md={10} className="m-auto">
                  ...
                  >
                    ...
                    <div className="card-body">
                      <p className="card-text fw-bold fs-1">{post.title} <span className="fs-6 text-white-50">by: {user.name}</span></p>
